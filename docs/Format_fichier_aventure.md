...
| `completionText` | **oui**, sur un trajet qui mène quelque part | Ce que l'enfant lit sous « Bravo ! » quand la boîte est pleine : « Tu as trouvé tous les mots « en voiture ». Tu peux prendre la voiture. » Rien n'est composé à sa place ; absent, l'aventure est *à finir*. Ne pas y nommer le lieu d'arrivée : il se découvre en y entrant |
| `departureLabel` | **oui**, sur un trajet qui mène quelque part | L'action écrite sur le bouton de départ, à l'infinitif : « Prendre la voiture », « Quitter le garage ». Absente, l'aventure est *à finir* |
